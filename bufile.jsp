<%-- 
    Document   : bufile
    Created on : Aug 28, 2015, 6:26:02 PM
    Author     : hari
--%>
...
<body>
	<div id="header">
		...
		<ul id="menu">
			...
			<li class="active"><a href="bufile.jsp">User File Request</a></li>
...
<h2>Competition And Cooperation Among  <em title="Sharing, Data Management and Collaboration">Cloud Provider</em></h2>
	...
	<div id="bar">
		<div class="wrap">
                    <span class="step" style="color:#ff6666"><a>1</a> File Request</span>
...
ResultSet rs= st.executeQuery("select * from FILES where BROKERSTATUS='processing' order by FID ");
while(rs.next())
{%>
...
<tr> <td> <%=rs.getString(1)%></td><td> &nbsp;&nbsp;&nbsp; </td>
  ...
  <%String stt=rs.getString(9);
    ...
    <td> <%=rs.getString(11)%></td>    <td> &nbsp;&nbsp;&nbsp; </td>
  <td>
                          <form action="bufile.jsp?vall=12" method="post">
