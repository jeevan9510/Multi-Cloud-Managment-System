<%-- 
    Document   : cuser
    Created on : Jul 27, 2015, 2:04:46 PM
    Author     : hari
--%>
<%@include file="db.jsp" %>
<%
...
ResultSet rs= st.executeQuery("select * from users where UNAME='"+name+"' and PASSWORD='"+pw+"'");
...
<body>
	...
	<div id="bar">
		<div class="wrap">
			<span class="step"  style="color:#ff6666" ><a>1</a> Cloud User</span>
	...
	<div class="wrap">
            ...
            <center><h2 style="color:#6666ff">Login Form</h2>
                ...
                <table align="center">
                      ...
                      <tr> <td> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </td>  <td>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</td>  </tr>
                  <tr> <td> Your New User  </td>  <td><a href="register.jsp">click it</a></td>  </tr>
                  </table>
                </form>
            </center>
